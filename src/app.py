...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team drills and compete in friendly matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["sarah@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming techniques and endurance in the pool",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["natalie@mergington.edu", "james@mergington.edu"]
    },
    "Art Club": {
    ...
    "Theater Workshop": {
        "description": "Develop acting skills and prepare a stage performance",
    ...
    "Debate Team": {
        "description": "Practice argumentation and public speaking for debate tournaments",
